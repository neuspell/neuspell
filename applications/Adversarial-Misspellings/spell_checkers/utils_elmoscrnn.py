...
# NOTE
# ----
# Copied all file from ../../utils/trained/elmosclstm.py
############################################
...
#############################################
# USAGE
# cd src/utils/trained
# CUDA_VISIBLE_DEVICES=2 python elmosclstm.py probword ../../../data -1
# or..
# CUDA_VISIBLE_DEVICES=2 python elmosclstm.py probword ../../../data 1
# CUDA_VISIBLE_DEVICES=2 python elmosclstm.py probword ../../../data 4
#############################################
    ...
    for batch_id, (batch_clean_sentences,batch_corrupt_sentences) in tqdm(enumerate(data_iter)):
        ...
        try:
            with torch.no_grad():
                ...
                NEW: batch_predictions can now be of shape (batch_size,batch_max_seq_len,topk) if topk>1, else (batch_size,batch_max_seq_len)
                """
                batch_loss, batch_predictions = model(batch_idxs, batch_lengths, batch_elmo_inp, targets=batch_labels, topk=topk)
        except RuntimeError:
        ...
        if topk==1:
            ...
            batch_predictions = untokenize_without_unks2(batch_predictions, batch_lengths, vocab, batch_clean_sentences, topk=None)
...
if __name__=="__main__":
    ...
    # "./drive/My Drive/2019-20 CMU/Courses/11690/data" or "../../../data"
    ...
    TRAIN_BATCH_SIZE, VALID_BATCH_SIZE = 64, 128
