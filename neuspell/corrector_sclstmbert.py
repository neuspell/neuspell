...
from scripts.seq_modeling.sclstmbert import load_model, load_vocab_dict, load_pretrained, model_predictions, model_inference
...
""" corrector module """
class CorrectorSCLstmBert(object):
    ...
    def __init__(self, tokenize=True, pretrained=False, device="cpu"):
        ...
        self.ckpt_path = f"{DEFAULT_DATA_PATH}/checkpoints/scrnnbert-probwordnoise"
