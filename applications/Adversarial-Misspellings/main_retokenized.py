...
if params['sc_atd']:
    ...
    print("###########")
    checker = CorrectorElmoSCLstm(DATA_FOLDER_PATH=ELMOSCRNN_DATA_FOLDER_PATH)
...
test = read_dataset("data/classes/test_retokenized.txt")
...
def main():
    ...
    if 'train' in mode.lower():
        ...
        if type_of_attack is not None:
            check_against_spell_mistakes('data/classes/test_retokenized.txt')
