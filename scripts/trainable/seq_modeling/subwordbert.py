...
#############################################
# USAGE
# CUDA_VISIBLE_DEVICES=1 python subwordbert.py probword ../../data -1
#
# CUDA_VISIBLE_DEVICES=1 python subwordbert.py none ../../data 1
# CUDA_VISIBLE_DEVICES=1 python subwordbert.py random ../../data 1
# CUDA_VISIBLE_DEVICES=1 python subwordbert.py word ../../data 1
# CUDA_VISIBLE_DEVICES=1 python subwordbert.py prob ../../data 1
# CUDA_VISIBLE_DEVICES=1 python subwordbert.py probword ../../data 1
# CUDA_VISIBLE_DEVICES=1 python subwordbert.py probword_v2 ../../data 1
#############################################
...
def model_predictions(model, data, vocab, DEVICE, BATCH_SIZE=16):
    ...
    for batch_id, (batch_labels,batch_sentences) in enumerate(data_iter):
        ...
        print("In model_predictions len batch_labels_", len(batch_labels_))
...
if __name__=="__main__":
    ...
    if TRAIN_NOISE_TYPE=="word":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/subwordbert-wordnoise")
    elif TRAIN_NOISE_TYPE=="prob":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/subwordbert-probnoise")
    elif TRAIN_NOISE_TYPE=="random":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/subwordbert-randomnoise")
    elif TRAIN_NOISE_TYPE=="probword":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/subwordbert-probwordnoise")
    elif TRAIN_NOISE_TYPE=="probword_v2":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/subwordbert-probwordnoise_v2")
    elif TRAIN_NOISE_TYPE=="none":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/subwordbert-none")
    else:
    ...
    if START_EPOCH>0:
        ...
        INFER_BATCH_SIZE = 16
        ANALYSIS_DIR = f"../seq_modeling_analysis/subwordbert/analysis_{TRAIN_NOISE_TYPE}_bea4k"
        '''
        '''
        paths = [TRAIN_TEST_FILE_PATH1]
        files1 = ["test.bea60k"]
        ...
        '''
        paths = [TRAIN_TEST_FILE_PATH1]
        files1 = ["test.bea60k.lowercased"]
        files2 = ["test.bea60k.lowercased.noise.ambiguous"]
        INFER_BATCH_SIZE = 6
        '''
        # '''
        paths = [TRAIN_TEST_FILE_PATH1, TRAIN_TEST_FILE_PATH1]
        ...
        INFER_BATCH_SIZE = 8
        ANALYSIS_DIR = f"../seq_modeling_analysis/subwordbert/analysis_{TRAIN_NOISE_TYPE}_jfleg"
        '''
