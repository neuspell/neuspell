...
TRAIN_TEST_DATA_PATH = neuspell.paths.DEFAULT_TRAINTEST_DATA_PATH
...
for Checker in all_checkers:
    ...
    checker.evaluate(f"{TRAIN_TEST_DATA_PATH}/sample_clean.txt",
                     f"{TRAIN_TEST_DATA_PATH}/sample_corrupt.txt")
...
if SclstmChecker in all_checkers:
    ...
    print("model size: ", checker._model_size(checker.model))
