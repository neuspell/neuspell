...
from scripts.seq_modeling.cnnlstm import load_model, load_vocab_dict, load_pretrained, model_predictions, model_inference
from scripts.seq_modeling.helpers import load_data
from commons import spacy_tokenizer, DEFAULT_DATA_PATH


""" corrector module """
class CorrectorCnnLstm(object):
    ...
    def __init__(self, tokenize=True, pretrained=False, device="cpu"):
        ...
        self.ckpt_path = f"{DEFAULT_DATA_PATH}/checkpoints/cnn-lstm-probwordnoise"
