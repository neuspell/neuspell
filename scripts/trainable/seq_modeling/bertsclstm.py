...
#############################################
# USAGE
# CUDA_VISIBLE_DEVICES=1 python bertsclstm.py probword ../../data -1
#
# CUDA_VISIBLE_DEVICES=1 python bertsclstm.py none ../../data 1
# CUDA_VISIBLE_DEVICES=1 python bertsclstm.py random ../../data 1
# CUDA_VISIBLE_DEVICES=1 python bertsclstm.py word ../../data 1
# CUDA_VISIBLE_DEVICES=1 python bertsclstm.py prob ../../data 1
# CUDA_VISIBLE_DEVICES=1 python bertsclstm.py probword ../../data 1
# CUDA_VISIBLE_DEVICES=1 python bertsclstm.py probword_v2 ../../data 1
#############################################
...
def load_model(vocab):
    ...
    model = BertSCLSTM(3*len(vocab["chartoken2idx"]),vocab["token2idx"][ vocab["pad_token"] ],len(vocab["token_freq"]))
    print(model)
...
if __name__=="__main__":
    ...
    if TRAIN_NOISE_TYPE=="word":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/bertscrnn-wordnoise")
    elif TRAIN_NOISE_TYPE=="prob":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/bertscrnn-probnoise")
    elif TRAIN_NOISE_TYPE=="probword":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/bertscrnn-probwordnoise")
    elif TRAIN_NOISE_TYPE=="none":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/bertscrnn-none")
    else:
    ...
    if START_EPOCH>0:
        ...
        files2 = ["test.1blm.noise.random","test.1blm.noise.word","test.1blm.noise.prob"]
        INFER_BATCH_SIZE = 20
