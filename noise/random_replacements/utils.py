"""
# copied this file from src/scripts/trained/helpers2.py
# the helpers2 file was originally copied from Danish et al. 2019
# it does 4 types of edits for words with len>2
#   swap, add, drop, key
#   only one of these operations is applied to any word at a time
#   the selection of one of these opertaions for any word is random,
#       with equal chances
"""
...
def get_line_representation(lines, rep_list=['swap','drop','add','key','none'], probs=[0.1,0.1,0.1,0.1,0.6]):
    print(rep_list)
    print(probs)
    # rep = []
