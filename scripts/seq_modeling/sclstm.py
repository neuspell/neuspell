...
#############################################
# USAGE
# CUDA_VISIBLE_DEVICES=0 python sclstm.py probword ../../data -1
#
# CUDA_VISIBLE_DEVICES=1 python sclstm.py none ../../data 1
# CUDA_VISIBLE_DEVICES=1 python sclstm.py random ../../data 1
# CUDA_VISIBLE_DEVICES=1 python sclstm.py word ../../data 1
# CUDA_VISIBLE_DEVICES=1 python sclstm.py prob ../../data 1
# CUDA_VISIBLE_DEVICES=1 python sclstm.py probword ../../data 1
# CUDA_VISIBLE_DEVICES=1 python sclstm.py probword_v2 ../../data 1
#############################################
...
if __name__=="__main__":
    ...
    if len(sys.argv)>4:
        ...
        if FINETUNE=='probword':
            SRC_CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/scrnn-probwordnoise")
    ...
    if TRAIN_NOISE_TYPE=="word":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/scrnn-wordnoise")
    elif TRAIN_NOISE_TYPE=="prob":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/scrnn-probnoise")
    elif TRAIN_NOISE_TYPE=="random":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/scrnn-randomnoise")
    elif TRAIN_NOISE_TYPE=="probword":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/scrnn-probwordnoise")
    elif TRAIN_NOISE_TYPE=="probword_v2":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/scrnn-probwordnoise_v2")
    elif TRAIN_NOISE_TYPE=="bea40kfinetune":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/scrnn-probwordnoise-bea40kfinetune")
    elif TRAIN_NOISE_TYPE=="moviereviewsfinetune":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/scrnn-probwordnoise-moviereviewsfinetune2")
    elif TRAIN_NOISE_TYPE=="none":
        CHECKPOINT_PATH = os.path.join(BASE_PATH, "checkpoints/scrnn-none")
    else:
    ...
    if START_EPOCH>0:
        ...
        INFER_BATCH_SIZE = 16
        ANALYSIS_DIR = f"../seq_modeling_analysis/scrnn/analysis_{TRAIN_NOISE_TYPE}_bea4k"
        '''
        '''
        paths = [TRAIN_TEST_FILE_PATH1]
        files1 = ["test.bea60k"]
        ...
        INFER_BATCH_SIZE = 8
        ANALYSIS_DIR = f"../seq_modeling_analysis/scrnn/analysis_{TRAIN_NOISE_TYPE}_jfleg"
        '''
        '''
        paths = [TRAIN_TEST_FILE_PATH1]
        files1 = ["test.jfleg"]
        ...
        INFER_BATCH_SIZE = 8
        ANALYSIS_DIR = f"../seq_modeling_analysis/scrnn/analysis_{TRAIN_NOISE_TYPE}_ambiguous_natural_v7"
        for x,y,z in zip(paths,files1,files2):
            print(x,y,z)
            test_data = load_data(x,y,z)
            print ( num_unk_tokens([i[0] for i in test_data], vocab) )
